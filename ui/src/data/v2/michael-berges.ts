...
export const MICHAEL_BERGES_V2: CandidateFullV2 = {
  ...
  "campaignFinance": {
    ...
    "narrative": "No itemized donor table, treasurer filing, or 2026 campaign-finance report for Berges's county commission campaign was found in the reviewed public web sources. This should be treated as a records gap, not as evidence that no contributions exist.",
    "donors": [],
  ...
  "sources": [
    ...
    },
    {
      ...
      "claimsAnchored": [
        ...
        "The article identified Berges as Hays vice-mayor, Development Services of Northwest Kansas employee, ARC of Central Plains treasurer, Tiger Takedown Club chair, St. Joseph Catholic Church member, and participant at Firs...",
        "Hays Commissioner Announces County Run -- Hays Post"
      ]
    },
    {
      ...
      "claimsAnchored": [
        ...
        "HaysPost Candidate Profile: Michael Berges",
        "Candidate Profile -- Hays Post",
        "Hays Post: Berges Candidate Profile"
      ]
    },
    {
    ...
    },
    {
      ...
      "accessed": "2026-05-20",
      "claimsAnchored": [
        "Source/lead URLs: https://www.facebook.com/EllisCountyDistrict1/ (lead only); https://www.facebook.com/HaysDailyNews/posts/ellis-county-commission-chair-michael-berges-asserted-that-commissioners-are-not/150924030436217..."
      ]
    },
    {
      ...
      "accessed": "2026-05-20",
      "claimsAnchored": [
        "Hays Daily News -- Berges Commission Comment"
      ]
    }
  ]
};
