...
export const KEVIN_LATZ_V2: CandidateFullV2 = {
  "slug": "kevin-latz",
  "name": "Kevin Latz",
  "party": "D",
...
if (process.env.NODE_ENV !== "production") {
  const result = validateCandidateV2(KEVIN_LATZ_V2);
  if (!result.ok) {
    // eslint-disable-next-line no-console
    console.error(
      "[kevin-latz.ts] validateCandidateV2 FAILED:\n" +
        result.errors.join("\n"),
    );
  }
}
