...
export const RIC_KOEHN_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "The updated state roster audit found Ric Koehn on the Kansas SOS 2026 General candidate list for Insurance Commissioner as a Libertarian candidate filed on May 12, 2026; KPDC records separately show the campaign-finance account. ",
        "sourceIds": [
          "s-sos-2026-general"
        ]
      },
