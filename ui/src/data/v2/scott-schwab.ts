...
export const SCOTT_SCHWAB_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "As a Christian, my faith has guided me - Scott Schwab campaign site, 2026-04-01, https://scottschwab.com/ - topic: faith and worldview. ",
        "sourceIds": [
          "s-campaign-site"
        ]
      },
    ...
    },
    {
      ...
      "stated": {
        "text": "The reviewed set contains one personal health update rather than a health-policy item. KCTV/WIBW reported Schwab’s March 21, 2025 social-media post on surgery for cancer, quoting him: \"My doctors have confirmed it was found very early, and no further treatment will be required post-surgery. I will make a full recovery.\" (source) ",
        "sourceIds": [
    ...
    },
    {
      ...
      "actions": [
        ...
        {
          "id": "em-scott-schwab-00306",
          "date": "2026-04-01",
          "body": "Scott Schwab Conservative Results - campaign homepage, 2026-04-01, scottschwab.com - topic: campaign identity.",
          "sourceIds": [
            "s-campaign-site"
          ]
        }
    ...
    },
    {
      ...
      "socialSignals": [
        ...
        {
          "id": "soc-scott-schwab-0015",
          "platform": "YouTube",
          "observation": "YouTube: https://www.youtube.com/@kansassecretaryofstate; office channel metadata accessible.",
          "observedAt": "2026-05-20",
          "sourceIds": [
            "src-scott-schwab-0175"
          ],
          "mappedToIssueId": "i-local-governance-transparency-ethics"
        }
      ]
