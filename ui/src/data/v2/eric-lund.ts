...
export const ERIC_LUND_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "Reviewed evidence: slug: \"kansas-insurance-2026\" The disk matrix keeps 4 selected evidence items for this issue, including 0 public URL-backed items and 4 internal-memory items.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
    },
    {
      ...
      "actions": [
        {
          "id": "em-eric-lund-00045",
          "date": "Undated",
          "body": "\"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW05EL_AT.pdf\"",
          "sourceIds": [
            "s-kpdc-at"
          ]
        }
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW05EL_AT.pdf\"",
        "sourceIds": [
          "s-kpdc-at"
        ]
      },
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"incumbent\": false The disk matrix keeps 22 selected evidence items for this issue, including 0 public URL-backed items and 22 internal-memory items. Social/online signals are included only as observed behavior and are not treated as confirmed beliefs or policy positions.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
