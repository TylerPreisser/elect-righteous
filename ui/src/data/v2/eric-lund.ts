...
export const ERIC_LUND_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "The updated state roster audit found Eric Lund on the Kansas SOS 2026 General candidate list for State Treasurer as a Libertarian candidate filed on May 12, 2026; KPDC records separately show the campaign-finance account. ",
        "sourceIds": [
          "s-sos-2026-general"
        ]
      },
  ...
  "recordSummary": "The current record confirms a Kansas SOS 2026 General filing for state treasurer and a KPDC treasurer appointment/account record. No candidate-controlled issue platform was found in the reviewed public record, so issue entries remain evidence-limited and caveated.",
