/* Auto-generated from memory/candidates/lorie-wood/v2-issues.yaml.
 * Edit the YAML source, then run:
 *   node scripts/compile-v2-yaml.mjs lorie-wood
 */

import type { CandidateFullV2 } from "@/data/types-v2";
import { validateCandidateV2 } from "@/data/types-v2";

export const LORIE_WOOD_V2: CandidateFullV2 = {
  "slug": "lorie-wood",
  "name": "Lorie Wood",
  "party": "NP",
  ...
  "issues": [
    {
      ...
      "title": "Abortion / life",
      "stated": {
        "text": "Reviewed evidence: Across the captured period the feed contains no posts about abortion, immigration, guns, religious liberty, Fort Riley, Fort Hays State University, the Ogallala Aquifer, or water policy (harvest). The captured feed includes two items that mention farms or rural hospitals, but it does not include a farm-policy plan (harvest). The disk matrix keeps 1 selected evidence item for this issue, including 0 public URL-backed items and 1 internal-memory item. Social/online signals are included only as observed behavior and are not treated as confirmed beliefs or policy positions.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
    ...
    },
    {
      ...
      "stated": {
        "text": "Reviewed evidence: The highest-engagement YouTube item in the captured set was *There SHOULD be TERM LIMITS*, with 1,558 views and a rating count of 45 as of May 11, 2026 (harvest). The next highest by rating count was *HEALTHCARE is a RIGHT*, with 1,409 views and a rating count of 32 as of May 11, 2026 (harvest). Other high-view items included affordability at 1,340 views, *America's Broken Promises* at 1,261 views, and housing at 1,... The disk matrix keeps 2 selected evidence items for this issue, including 0 public URL-backed items and 2 internal-memory items. Social/online signals are included only as observed behavior and are not treated as confirmed beliefs or policy positions.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": [
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"url\": \"https://www.kansas.gov/ethics/CFAScanned/EdOdd/2026ElecCycle/Treasurers/BOE05LW_AT.pdf\"",
        "sourceIds": [
          "s-kpdc-at"
        ]
      },
...
if (process.env.NODE_ENV !== "production") {
  const result = validateCandidateV2(LORIE_WOOD_V2);
  if (!result.ok) {
    // eslint-disable-next-line no-console
    console.error(
      "[lorie-wood.ts] validateCandidateV2 FAILED:\n" +
        result.errors.join("\n"),
    );
  }
}
