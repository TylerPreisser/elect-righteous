/* Auto-generated from memory/candidates/mark-lane/v2-issues.yaml.
 * Edit the YAML source, then run:
 *   node scripts/compile-v2-yaml.mjs mark-lane
 */
...
export const MARK_LANE_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "actions": [
        {
          "id": "em-mark-lane-00045",
          "date": "Undated",
          "body": "\"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW01ML_AT.pdf\"",
          "sourceIds": [
            "s-kpdc-at"
          ]
        }
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW01ML_AT.pdf\" The disk matrix keeps 3 selected evidence items for this issue, including 1 public URL-backed item and 2 internal-memory items.",
        "sourceIds": [
          "s-kpdc-at"
        ]
      },
