/* Auto-generated from memory/candidates/brandon-adams/v2-issues.yaml.
 * Edit the YAML source, then run:
 *   node scripts/compile-v2-yaml.mjs brandon-adams
 */

import type { CandidateFullV2 } from "@/data/types-v2";
import { validateCandidateV2 } from "@/data/types-v2";

export const BRANDON_ADAMS_V2: CandidateFullV2 = {
  "slug": "brandon-adams",
  "name": "Brandon Adams",
  "party": "NP",
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "No public URL-backed candidate statement or documented action was separated for Economy / jobs / labor in the rendered profile. this page does not infer a position from party, faith, follows, likes, associations, or internal-only notes.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
    ...
    },
    {
      ...
      "actions": [
        {
          "id": "em-brandon-adams-00045",
          "date": "Undated",
          "body": "\"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW01BA_AT.pdf\"",
          "sourceIds": [
            "s-kpdc-at"
          ]
        }
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"url\": \"https://www.kansas.gov/ethics/CFAScanned/StWide/2026ElecCycle/Treasurers/SW01BA_AT.pdf\" The disk matrix keeps 3 selected evidence items for this issue, including 1 public URL-backed item and 2 internal-memory items.",
        "sourceIds": [
          "s-kpdc-at"
        ]
      },
    ...
    },
    {
      ...
      "stated": {
        "text": "No public URL-backed candidate statement or documented action was separated for Local governance / transparency / ethics in the rendered profile. 18 internal-memory evidence items remain on disk for editorial review, but this page does not infer a position from party, faith, follows, likes, associations, or internal-only notes. Public social/online observations exist on disk, but they are not treated as confirmed issue positions.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
  ...
  "whoTheyAre": "Brandon Adams appears in KPDC's 2026 statewide campaign-finance index under gubernatorial candidates. Party and final ballot status were not confirmed in the reviewed filing mirror.",
  "recordSummary": "This profile exists so the site does not miss a public campaign-finance account connected to the governor race. It should remain clearly marked as finance-account confirmed, not final-ballot confirmed.",
...
if (process.env.NODE_ENV !== "production") {
  const result = validateCandidateV2(BRANDON_ADAMS_V2);
  if (!result.ok) {
    // eslint-disable-next-line no-console
    console.error(
      "[brandon-adams.ts] validateCandidateV2 FAILED:\n" +
        result.errors.join("\n"),
    );
  }
}
