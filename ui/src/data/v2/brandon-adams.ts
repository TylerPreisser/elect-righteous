...
export const BRANDON_ADAMS_V2: CandidateFullV2 = {
  ...
  "issues": [
    ...
    },
    {
      ...
      "stated": {
        "text": "Reviewed evidence: The governor signs or vetoes bills, writes budgets, appoints agency leaders, and shapes policy on education, taxes, roads, public health, and much more. The disk matrix keeps 1 selected evidence item for this issue, including 0 public URL-backed items and 1 internal-memory item.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
    ...
    },
    {
      ...
      "stated": {
        "text": "Documented-record evidence: \"incumbent\": false The disk matrix keeps 18 selected evidence items for this issue, including 0 public URL-backed items and 18 internal-memory items. Social/online signals are included only as observed behavior and are not treated as confirmed beliefs or policy positions.",
        "sourceIds": []
      },
      "actions": [],
      "socialSignals": []
