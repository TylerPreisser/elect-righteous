...
export const MICHELLE_CUNNINGHAM_V2: CandidateFullV2 = {
  ...
  "whoTheyAre": "Michelle Cunningham appears in KPDC's State Board of Education odd-district index under District 5. Party, platform, and final ballot status were not confirmed in the reviewed public record.",
