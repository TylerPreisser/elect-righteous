# Notes — candidate-evidence-miner — michelle-cunningham — 2026-05-20

## Summary
- Files read: 7
- Raw rows extracted: 391
- Caveat/conflict/source-limitation rows: 2
- Internal-memory rows without URL: 371

## Files Read
- memory/candidates/michelle-cunningham/in-their-own-words.md
- memory/candidates/michelle-cunningham/raw-dump-v2.md
- memory/candidates/michelle-cunningham/sleuth-pass.md
- memory/candidates/michelle-cunningham/social-harvest.md
- memory/candidates/michelle-cunningham/v2-issues.yaml
- ui/src/data/elections.ts
- ui/src/data/v2/michelle-cunningham.ts
...
- 10. Election integrity / voting / courts: 55 rows
- 11. Public safety / law enforcement / criminal justice: 4 rows
- 12. Agriculture / rural economy / water: 3 rows
- 13. Local governance / transparency / ethics: 127 rows
