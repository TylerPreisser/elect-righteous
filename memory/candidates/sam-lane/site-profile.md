...
## Their Record
Lane has no previous elected office, so his public record is essentially the campaign itself. He uses his website to explain the secretary of state's duties and to argue that the office should be a safeguard for Kansas elections and business filings rather than a stage for ideological fights.
...
## Campaign Finance
Lane's 2025 filing showed $590.91 raised, and $580.27 of that came from Lane himself. The report reads like a seed-stage campaign financed almost entirely out of the candidate's own pocket.
...
> -- Samuel Lane campaign website, accessed April 1, 2026, https://www.samuellane.org/
