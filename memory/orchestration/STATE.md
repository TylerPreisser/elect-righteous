...
| Cloudflare Pages deploy | 2026-05-20T21:22:00-05:00 | Pass | Built root-domain export with `NEXT_PUBLIC_SITE_URL=https://electrighteous.com`, deployed via Wrangler, and verified `https://e230d8cb.elect-righteous.pages.dev/` plus `https://elect-righteous.pages.dev/` return HTTP 200. |
| Production domain verification | 2026-05-20T21:22:00-05:00 | Pass | `https://electrighteous.com/` and `https://www.electrighteous.com/` return HTTP 200 and production metadata uses `https://electrighteous.com/` rather than GitHub Pages URLs. Targeted forbidden/internal wording scan is clean on production home and Steven Jacob pages. |
